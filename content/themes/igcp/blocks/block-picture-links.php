    ...
    <ul class="blk-PictureLinks_Items">
      ...
      <li class="blk-PictureLinks_Item">
        <div class="blk-PictureLink">
          <a class="blk-PictureLink_FauxLink" href="<?php echo $link_1_url; ?>" name="<?php echo $link_1_title; ?>"></a>
      ...
      <li class="blk-PictureLinks_Item">
        <div class="blk-PictureLink">
          <a class="blk-PictureLink_FauxLink" href="<?php echo $link_2_url; ?>" name="<?php echo $link_2_title; ?>"></a>
          <div class="blk-PictureLink_Body">
            <div class="blk-PictureLink_ImageWrap">
      ...
      <li class="blk-PictureLinks_Item">
        <div class="blk-PictureLink">
          <a class="blk-PictureLink_FauxLink" href="<?php echo $link_3_url; ?>" name="<?php echo $link_3_title; ?>"></a>
          <div class="blk-PictureLink_Body">
            <div class="blk-PictureLink_ImageWrap">
      ...
      <li class="blk-PictureLinks_Item">
        <div class="blk-PictureLink">
          <a class="blk-PictureLink_FauxLink" href="<?php echo $link_4_url; ?>" name="<?php echo $link_4_title; ?>"></a>
          <div class="blk-PictureLink_Body">
            <div class="blk-PictureLink_ImageWrap">
