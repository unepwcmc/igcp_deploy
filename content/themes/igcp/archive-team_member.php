 ...
 */
	...
	set_query_var('hero-text', get_theme_mod( 'team_page_hero_text' ));
	set_query_var('hide-text', get_theme_mod( 'team_page_hero_hide_text' ));

	// Archive pages only have one button
	set_query_var('hero-link-url-2', get_theme_mod( 'team_page_hero_button_url' ));
	set_query_var('hero-link-text-2', get_theme_mod( 'team_page_hero_button_text' ));
	set_query_var('hide-buttons', get_theme_mod( 'team_page_hero_hide_button' ));
							...
							<?php while ( have_posts() ) : the_post();
								...
								*/ ?>
								<li class="lyt-Entry_Item">
									<?php get_template_part( 'template-parts/components/cards/card', 'team' ); ?>
								</li>
							<?php endwhile; ?>
						</ul>
						<?php
